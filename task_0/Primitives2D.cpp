...
const Point2D::componentType &Point2D::x() {
    return x_;
}
...
const Point2D::componentType &Point2D::y() {
    return y_;
}
...
Vector2D::componentType Vector2D::dot(const Vector2D &other) {
    return x_ * other.x_ + y_ * other.y_;
}

Vector2D::componentType Vector2D::cross_z(const Vector2D &other) {
